...
namespace Domore.Conf {
    ...
    internal class ConfBlockFactory {
        ...
        private class ConfBlock : IConfBlock {
            ...
            public IEnumerable<T> Configure<T>(Func<T> factory, string collection, IEqualityComparer<string> comparer) =>
                Collect.All(factory, collection, comparer, this);

            public IEnumerable<KeyValuePair<string, T>> Configure<T>(Func<string, T> factory, string collection, IEqualityComparer<string> comparer) =>
                Collect.Indexed(factory, collection, comparer, this);
