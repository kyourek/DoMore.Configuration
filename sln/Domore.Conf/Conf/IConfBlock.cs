...
namespace Domore.Conf {
    ...
    public interface IConfBlock {
        ...
        [ComVisible(false)]
        IEnumerable<T> Configure<T>(Func<T> factory, string collection = null, IEqualityComparer<string> comparer = null);

        [ComVisible(false)]
        IEnumerable<KeyValuePair<string, T>> Configure<T>(Func<string, T> factory, string collection = null, IEqualityComparer<string> comparer = null);
